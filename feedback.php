...
<title>MCQ SYSTEM ||  FEEDBACK </title>
...
<div class="modal fade title1" id="aboutus">
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <h4 style="font-family:'typo' ">Currently Studying in 3 semester at JECRC university. </h4>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7892517729</h4>
		<h4 style="font-family:'typo' ">ravi.chudgar@gmail.com</h4>
		<h4 style="font-family:'typo' ">JECRC DISTANCE EDUCATION , JAIPUR</h4></div></div>
		</p>
      </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7892517729</h4>
		<h4 style="font-family:'typo' ">ravi.chudgar@gmail.com</h4>
		<h4 style="font-family:'typo' ">JECRC University ,JAIPUR</h4></div></div>
		</p>
      </div>
